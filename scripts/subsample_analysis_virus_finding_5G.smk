with open('subsampling/subsamples_5G.txt', 'r') as f:
    samples = f.read().splitlines()

# ls Virome/subsampling/*_5G_R1.fastq.gz | sed 's/_R1.fastq.gz$//' | sed 's#.*/##' > Virome/subsampling/subsamples_5G.txt
...
rule Clustering:
    ...
    output:
        Leiden_dereplicated = "subsampling/5-dereplication/combined_Genomad_5G_vOTUs.fna",
