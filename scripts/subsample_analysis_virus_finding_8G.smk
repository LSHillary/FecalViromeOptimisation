with open('subsampling/subsamples_8G.txt', 'r') as f:
    samples = f.read().splitlines()

# ls Virome/subsampling/*_8G_R1.fastq.gz | sed 's/_R1.fastq.gz$//' | sed 's#.*/##' > Virome/subsampling/subsamples_8G.txt
...
rule Clustering:
    ...
    output:
        Leiden_dereplicated = "subsampling/5-dereplication/combined_Genomad_8G_vOTUs.fna",
