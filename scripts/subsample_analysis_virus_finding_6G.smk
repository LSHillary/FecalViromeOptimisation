with open('subsampling/subsamples_6G.txt', 'r') as f:
    samples = f.read().splitlines()

# ls Virome/subsampling/*_6G_R1.fastq.gz | sed 's/_R1.fastq.gz$//' | sed 's#.*/##' > Virome/subsampling/subsamples_6G.txt
...
rule Clustering:
    ...
    output:
        Leiden_dereplicated = "subsampling/5-dereplication/combined_Genomad_16G_vOTUs.fna",
