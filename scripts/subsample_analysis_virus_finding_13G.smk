...
# ls Virome/subsampling/*_13G_R1.fastq.gz | sed 's/_R1.fastq.gz$//' | sed 's#.*/##' > Virome/subsampling/subsamples_13G.txt
...
rule Clustering:
    ...
    output:
        Leiden_dereplicated = "subsampling/5-dereplication/combined_Genomad_13G_vOTUs.fna",
