with open('subsampling/subsamples_9G.txt', 'r') as f:
    samples = f.read().splitlines()

# ls Virome/subsampling/*_9G_R1.fastq.gz | sed 's/_R1.fastq.gz$//' | sed 's#.*/##' > Virome/subsampling/subsamples_9G.txt
...
rule Clustering:
    ...
    output:
        Leiden_dereplicated = "subsampling/5-dereplication/combined_Genomad_9G_vOTUs.fna",
